...
const Backlinks = () => (
  <Container maxWidth="md" sx={{ mt: 4, mb: 4 }}>
    ...
    <Typography variant="body1" gutterBottom>
      Discover a curated list of resources related to CAD, AI, and technology. These links are essential for anyone looking to deepen their knowledge, stay updated with industry trends, or find tools that complement CADGuardian's offerings. Partnering with reputable sites in these areas can significantly improve our authority and ranking.
    </Typography>
          ...
          {backlinks[category].map((link, linkIndex) => (
            <Box sx={{ mb: 2 }} key={linkIndex}>
              <Typography variant="h6" sx={{ fontWeight: 'bold' }}>
                <Link href={link.href} color="primary" underline="hover" target="_blank" rel="noopener">
                  {link.text}
                </Link>
              </Typography>
