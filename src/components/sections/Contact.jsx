...
const Contact = () => {
	...
	return (
		<>
			<Helmet>
				<title>Contact Us - CADGuardian</title>
				<meta
					name="description"
					content="Get in touch with the CADGuardian team. Whether you have questions, need support, or want to explore partnerships, we are here to help."
				/>
			</Helmet>
			<Container>
				<Box
						...
						<Grid item xs={12} md={6}>
							<Box
								...
								<Typography
									...
									<a href="#">Privacy Policy</a>, <a href="#">Data Policy</a>{" "}
